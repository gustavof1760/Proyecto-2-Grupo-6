...
set_property PACKAGE_PIN E16 [get_ports p_timer]						
	set_property IOSTANDARD LVCMOS33 [get_ports p_timer]
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports bot_up]						
	set_property IOSTANDARD LVCMOS33 [get_ports bot_up]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports bot_left]						
	set_property IOSTANDARD LVCMOS33 [get_ports bot_left]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports bot_right]						
	set_property IOSTANDARD LVCMOS33 [get_ports bot_right]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports bot_down]						
	set_property IOSTANDARD LVCMOS33 [get_ports bot_down]
...
set_property PACKAGE_PIN G6 [get_ports a_d]					
...
set_property PACKAGE_PIN A3 [get_ports rgb_text_salida[8]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[8]]
##Bank = 35, Pin name = IO_L7N_T1_AD6N_35,					Sch name = VGA_R1
set_property PACKAGE_PIN B4 [get_ports rgb_text_salida[9]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[9]]
##Bank = 35, Pin name = IO_L1N_T0_AD4N_35,					Sch name = VGA_R2
set_property PACKAGE_PIN C5 [get_ports rgb_text_salida[10]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[10]]
##Bank = 35, Pin name = IO_L8P_T1_AD14P_35,					Sch name = VGA_R3
set_property PACKAGE_PIN A4 [get_ports rgb_text_salida[11]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[11]]
##Bank = 35, Pin name = IO_L2P_T0_AD12P_35,					Sch name = VGA_B0
set_property PACKAGE_PIN B7 [get_ports rgb_text_salida[0]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[0]]
##Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
set_property PACKAGE_PIN C7 [get_ports rgb_text_salida[1]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[1]]
##Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
set_property PACKAGE_PIN D7 [get_ports rgb_text_salida[2]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[2]]
##Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
set_property PACKAGE_PIN D8 [get_ports rgb_text_salida[3]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[3]]
##Bank = 35, Pin name = IO_L1P_T0_AD4P_35,					Sch name = VGA_G0
set_property PACKAGE_PIN C6 [get_ports rgb_text_salida[4]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[4]]
##Bank = 35, Pin name = IO_L3N_T0_DQS_AD5N_35,				Sch name = VGA_G1
set_property PACKAGE_PIN A5 [get_ports rgb_text_salida[5]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[5]]
##Bank = 35, Pin name = IO_L2N_T0_AD12N_35,					Sch name = VGA_G2
set_property PACKAGE_PIN B6 [get_ports rgb_text_salida[6]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[6]]
##Bank = 35, Pin name = IO_L3P_T0_DQS_AD5P_35,				Sch name = VGA_G3
set_property PACKAGE_PIN A6 [get_ports rgb_text_salida[7]]				
	set_property IOSTANDARD LVCMOS33 [get_ports rgb_text_salida[7]]
